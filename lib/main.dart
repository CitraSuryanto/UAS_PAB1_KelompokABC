...
import 'package:reviewhotelpab/pages/addHotel.dart';
import 'package:reviewhotelpab/pages/homepage.dart';
import 'package:reviewhotelpab/pages/login.dart';
import 'package:reviewhotelpab/pages/register.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: AuthWrapper(),
      routes: {
        '/home': (context) => const HomePage(userRole: '', userId: '', userName: '',),
